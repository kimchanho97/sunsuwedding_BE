...
### 📌 PG 기반 결제 시스템 리팩토링: 위변조 방지와 트랜잭션 정합성 보장
...
📂 [분산 환경에서 외부 결제 승인과 내부 트랜잭션의 일관성 보장을 위한 설계 (Notion)](https://kimchanho.notion.site/1cda1b1b004180a183c8dda1976e23b9)
...
이에 따라, JPA 대신 **JdbcTemplate을 이용한 batch insert** 방식을 도입하여 개선을 진행했습니다.
